...
router.post("/", (req, res) => {
	...
	request({
		...
		headers: {"Authorization": "Bearer v0ZVPbOiq_hpCphoAiab3wfPPIY4SAbjMgMb3W9Lu7mT4x" +
				  "HEghxZpMvhAZOX5o876fN1BNL6y3mb2bkXtO3SM43mCsrleJC0oXi6tUM9O2Da4CD7HOwGhw" +
				  "Ub3nBTWXYx".toString()}
	}, (error, response, body) => {
		...
		if (body.error) {
			res.render("index", {
				error_msg: "Location not found. Correct spelling."  
			});
		}
		else {
